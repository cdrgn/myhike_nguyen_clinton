...
var currentUser; // good idea to put global variable at the top
...
function doAll() {
    firebase.auth().onAuthStateChanged(user => {
        if (user) {
            ...
            console.log(currentUser.get() + "hhh");
...
function displayCardsDynamically(collection) {
    ...
    db.collection(collection)
        .orderBy("length", "desc") //sort by hike distance, longest first
        // .limit(1)
...
// 2. if it is solid, make it hollow, and remove the hike from the user's "bookmarks" array
//
// Hints: there is a ".includes()" to see if an element is in an array
// Hints: there is an ".arrayRemove()" function to remove an element from a Firestore array
    ...
    currentUser.get().then(doc => {
        ...
        if (currentBookmarks && currentBookmarks.includes(hikeDocID)) {
            ...
            .then(function() {
                ...
                let iconID = "save-" + hikeDocID; //"save-091823"
                console.log(iconID);
